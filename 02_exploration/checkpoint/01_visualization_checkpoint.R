...
subscribers_day_tbl %>%
    plot_acf_diagnostics(optin_time, log(optins + 1), .lags = 1000)
...
subscribers_day_tbl %>%
    plot_stl_diagnostics(optin_time, log(optins + 1), .frequency = "1 month", .trend = "1 year")
